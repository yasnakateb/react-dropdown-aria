...
var arrayReducer = function (acc, val) {
    if (helper_1.isOptionGroup(val)) {
...
var useDropdownHooks = function (props) {
    ...
    var flattenedOptions = react_1.useMemo(function () { return options.reduce(arrayReducer, []); }, [options]);
    var searchDropdown = search_hooks_1.default(setFocusedIndex, flattenedOptions);
    var styles = react_1.useRef(style);
